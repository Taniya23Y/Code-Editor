    ...
    >
      ...
      >
        <img
          ...
          width={400}
          height={400}
          className="opacity-80 mb-6 pt-0 max-w-full select-none pointer-events-none"
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-6 w-full">
        ...
        >
          <svg
            className="h-5 transition-transform duration-500 group-hover:rotate-360"
        ...
        >
          ...
          <span>Explore Editor | Compiler</span>
        </Link>
      </div>
    </motion.div>
  );
