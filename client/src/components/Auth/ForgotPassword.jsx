            ...
            >
              <Form className="space-y-4">
                <div className="relative">
                  ...
                  <FaEnvelope className="absolute left-3 top-10.5 text-gray-400 text-sm" />
                  <Field
                    type="email"
                    name="email"
            ...
            >
              <Form className="space-y-4">
                <div className="relative">
                  ...
                  <FaLock className="absolute left-3 top-9.5 text-gray-400 text-sm" />
                  <Field
                  ...
                  <button
                    ...
                    className="absolute right-3 top-9.5 text-gray-500 hover:text-blue-500"
                  >
